...
class TelemetrySummary(_message.Message):
    __slots__ = ("drone_id", "unix_time_ms", "lat_deg", "lon_deg", "rel_alt_m", "heading_deg", "ground_speed_ms", "flight_mode", "armed", "battery_v", "battery_pct", "health_all_ok")
