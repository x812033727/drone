...
> rev 2 · 2026-07。階段劃分/退出條件/里程碑不變;本版將 §4 Top-8 風險表移轉至 [risk-register.md](risk-register.md) 活登錄表,§4 縮為摘要+連結。版本紀錄見 §5。
...
Top-8 風險(R-01~R-08)已移轉至 **[risk-register.md](risk-register.md)** 活登錄表維護(欄含機率/衝擊/緩解/負責角色/狀態/最後覆核日),每週例會覆核並更新(治理節奏見 [team.md §4](team.md)、Phase 0 落地見 [phase0/README §6](phase0/README.md))。摘要:機率最高 = FC-H7 延期(R-01)與嵌入式/射頻招募(R-02);衝擊唯一「致命」= 現金流(R-08)。逐項內容以登錄表為單一事實來源,本節不再維護明細。
...
| 1 | 2026-07-11 | 小幅修訂(不升版):Phase 0 退出條件口徑改「文件修訂為 rev 2」、補 phase0/ 連結;§4 續航風險緩解隨 12S2P 定案更新 |
| 2 | 2026-07-12 | §4 Top-8 風險表移轉 [risk-register.md](risk-register.md)(活登錄表,加負責角色/狀態/覆核日欄),本檔縮為摘要+連結;形式化:補 rev 檔頭與版本紀錄 |
