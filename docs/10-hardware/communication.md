...
> rev 2 · 2026-07。rev 1 鏈路架構與雙鏈路策略不變;本版於 §4/§4.1 定案 Remote ID 模組選型(2026-07-11:Dronetag DRI OEM,替代料 BlueMark db201)並修正廣播制式口徑。版本紀錄見 §7。
...
| 2 | 2026-07-11 | §4/§4.1 Remote ID 模組選型定案(Dronetag DRI OEM,替代料 BlueMark db201)與候選評選表;制式口徑修正(BT5 LR 必備、WiFi NAN 可選) |
