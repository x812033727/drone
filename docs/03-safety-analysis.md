...
- **認證前置**:UN38.3(REQ-SAF-03);交付條款(T.1–T.8 全項報告 + Test Summary、變更即重測、Class 9/Wh/序號標籤銘板、BMS 運輸模式 SoC ≤ 30%)見 [propulsion §7.1](10-hardware/propulsion.md) 運輸合規列;過充/過放/短路/針刺濫用測試委外執行([propulsion §9](10-hardware/propulsion.md) 電池濫用列)。
