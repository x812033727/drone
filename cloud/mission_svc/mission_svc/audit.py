"""審計軌跡寫入(G14)。變更端點成功後旁路記一筆到 mission.audit_log。
...
from mission_svc.auth import ROLE_ORDER, extract_roles, role_rank

log = logging.getLogger("mission_svc.audit")

_RANK_TO_ROLE = {rank: name for name, rank in ROLE_ORDER.items()}

_INSERT = """
INSERT INTO mission.audit_log
